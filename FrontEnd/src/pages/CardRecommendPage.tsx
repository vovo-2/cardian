...
import { formatBenefitType, formatPrice } from "../utils/formatUtils";
          ...
          <div className="h-full flex flex-col justify-between">
            ...
            <div className="flex mx-auto">
              ...
              <div className="w-full">
                ...
                <div className="max-h-20 overflow-y-auto laptop:max-h-40">
            ...
            <div>
              ...
              <div className="w-full flex flex-col gap-3 text-xl px-5">
                <div className="w-full flex justify-between text-darkgray">
                  <span>내가 받은</span>
                  <span>
                    {formatPrice(recommendationCard?.recievedBenefitAmount)}
                  </span>
                </div>
                <div className="w-full flex justify-between font-bold">
                  <span>더 받을 수 있었던</span>
                  <span>{formatPrice(moreReceivedBenefit)}</span>
                </div>
                <hr className="my-2" />
                <div className="w-full flex justify-between text-darkgray">
                  <span>총 받을 수 있었던</span>
                  <span>
                    {formatPrice(recommendationCard?.maxBenefitAmount)}
                  </span>
                </div>
              </div>
            </div>
      ...
      {selectedCategory &&
        ...
        recommendationCard?.recievedBenefitAmount === 0 && (
          <div className="flex justify-center py-20">
            <span className="text-3xl font-semibold text-lightgray text-center">
